          ...
          <div className='row'>
            <div className='col-3'>
              <div className='famous-card position-relative '>
                <img src='images/f-2.jpg' className='img-fluid' alt='famous' />
            ...
            <div className='col-3'>
              <div className='famous-card position-relative '>
                <img src='images/macc.jpg' className='img-fluid' alt='famous' />
               <div className='famous-content position-absolute'>
            ...
            <div className='col-3'>
              <div className='famous-card position-relative '>
                <img src='images/iphon.jpg' className='img-fluid' alt='famous' />
               <div className='famous-content position-absolute'>
               <h5 className='text-dark'>Studio Display</h5>
                <h6 className='text-dark'>600 nits of brightness</h6>
                <p className='text-dark'>27-inch 5k Retina display</p>
